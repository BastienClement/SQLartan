...
/**
 * Mixin interface that provides required methods for implementing an IterableStream when a
 * class already implements Iterable.
 * This is achieved by first implementing Streamable and then using StreamableAdapter.
 */
public interface IterableAdapter<T> extends StreamableAdapter<T> {
	/**
	 * Returns the characteristics of a Spliterator built from the Iterator of the implementer.
	 * By default, assume IMMUTABLE and ORDERED.
	 */
